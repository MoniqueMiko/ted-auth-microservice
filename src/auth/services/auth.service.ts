...
export class AuthService {
    ...
    async store(data) {
        ...
        if (userExist) return await this._httpExceptionStrategy.responseHelper(409, 'Email already exists');
    ...
    async login(data) {
        ...
        return await this._httpExceptionStrategy.responseHelper(200, { jwt: jwt.access_token, email: user.email, name: user.fullName });
    }
